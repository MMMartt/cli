...
| `GOOGLE_WORKSPACE_CLI_FILE_AUDIT_LOG_FILE` | File path for file operation audit logs (Drive/Docs/Sheets/Slides/Forms, JSONL). Default: `~/.config/gws/file-ops-audit.jsonl` |
